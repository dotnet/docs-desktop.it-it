...
1. Selezionare la stampante da usare tramite il <xref:System.Windows.Forms.PrintDialog> componente.  
     ...
     Nell'esempio di codice seguente vengono gestiti due eventi. Nel primo, un <xref:System.Windows.Forms.Button> evento del controllo <xref:System.Windows.Forms.Control.Click> , <xref:System.Windows.Forms.PrintDialog> viene creata un'istanza della classe e la stampante selezionata dall'utente viene acquisita nella <xref:System.Windows.Forms.DialogResult> Proprietà.  
  
     Nel secondo evento, l' <xref:System.Drawing.Printing.PrintDocument.PrintPage> evento del <xref:System.Drawing.Printing.PrintDocument> componente, un documento di esempio viene stampato sulla stampante specificata.  
