...
> Benché il controllo <xref:System.Windows.Forms.ToolStrip> sostituisca il controllo <xref:System.Windows.Forms.ToolBar> aggiungendovi funzionalità, il controllo <xref:System.Windows.Forms.ToolBar> viene mantenuto per compatibilità con le versioni precedenti e per un eventuale uso futuro.  
 ...
 Gli esempi seguenti presuppongono che <xref:System.Windows.Forms.ToolBar> sia stato aggiunto un controllo a un Windows Form ( `Form1` ).  
...
2. Specificare le impostazioni delle proprietà per un singolo pulsante passando l'indice del pulsante tramite la <xref:System.Windows.Forms.ToolBar.Buttons%2A> Proprietà.  
  
     Nell'esempio seguente si presuppone che un modulo con un <xref:System.Windows.Forms.ToolBar> controllo sia già stato aggiunto.  
