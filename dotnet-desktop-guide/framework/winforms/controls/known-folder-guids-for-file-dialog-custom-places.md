...
È possibile utilizzare un oggetto <xref:System.Guid> per specificare una cartella nota di Windows Vista quando si aggiungono cartelle a una <xref:System.Windows.Forms.FileDialog.CustomPlaces%2A> raccolta. I GUID di cartella noti non fanno distinzione tra maiuscole e minuscole e sono definiti nel file KnownFolders. h nella Windows SDK.  
...
## <a name="list-of-guids"></a>Elenco di GUID  
 Nella tabella seguente sono elencate le cartelle note di Windows Vista e la relativa associazione <xref:System.Guid> .  
