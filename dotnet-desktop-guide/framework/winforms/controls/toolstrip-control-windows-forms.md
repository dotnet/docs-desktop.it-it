...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 [Procedura: Modificare la spaziatura e l'allineamento degli elementi ToolStrip in Windows Forms](how-to-change-the-spacing-and-alignment-of-toolstrip-items-in-windows-forms.md)  
 ...
 [Procedura: Modificare l'aspetto del testo e delle immagini ToolStrip in Windows Forms](how-to-change-the-appearance-of-toolstrip-text-and-images-in-windows-forms.md)  
 ...
 [Procedura: Eseguire il wrapping di un controllo di Windows Forms con ToolStripControlHost](how-to-wrap-a-windows-forms-control-with-toolstripcontrolhost.md)  
 ...
 [Procedura: Usare le descrizioni comando nei controlli ToolStrip](how-to-use-tooltips-in-toolstrip-controls.md)  
 Illustra la definizione delle descrizioni comandi per gli elementi <xref:System.Windows.Forms.ToolStrip>.  
  
 [Procedura: Spostare ToolStrip da ToolStripContainer a un modulo](how-to-move-a-toolstrip-out-of-a-toolstripcontainer-onto-a-form.md)  
 ...
 [Procedura: Creare un modulo con interfaccia a documenti multipli con controlli ToolStripPanel](how-to-create-an-mdi-form-with-toolstrippanel-controls.md)  
 ...
 [Procedura: Creare un modulo con interfaccia a documenti multipli con unione di menu e controlli ToolStrip](how-to-create-an-mdi-form-with-menu-merging-and-toolstrip-controls.md)  
 ...
 Viene descritto come utilizzare la <xref:System.Windows.Forms.ToolStripProfessionalRenderer> classe per creare un controllo composito che simula il **riquadro di spostamento** fornito da Microsoft® Outlook®.  
...
- [Procedura: creare un controllo ToolStrip di Windows Form di base con elementi standard utilizzando la finestra di progettazione](create-a-basic-wf-toolstrip-with-standard-items-using-the-designer.md)  
...
- [Procedura dettagliata: Creazione di un modulo con interfaccia a documenti multipli con unione di menu e controlli ToolStrip](walkthrough-creating-an-mdi-form-with-menu-merging-and-toolstrip-controls.md)  
