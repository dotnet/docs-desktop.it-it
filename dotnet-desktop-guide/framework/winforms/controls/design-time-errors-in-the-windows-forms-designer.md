...
### <a name="delegate-class-class-name-has-no-invoke-method-is-this-class-a-delegate"></a>La classe delegata ' \<class name> ' non ha un metodo Invoke. È questa classe un delegato
