...
## <a name="example"></a>Esempio  
 ...
 Per usare questo esempio di codice, compilare ed eseguire l'applicazione, quindi fare clic su **Middle (Spring)** sul <xref:System.Windows.Forms.StatusStrip> controllo per cambiare il valore della <xref:System.Windows.Forms.ToolStripStatusLabel.Spring%2A> Proprietà.  
