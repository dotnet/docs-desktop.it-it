...
---
# <a name="how-to-set-and-return-dates-with-the-windows-forms-datetimepicker-control"></a>Procedura: Impostare e restituire date con il controllo DateTimePicker di Windows Forms
