...
- Controllare la modalità di serializzazione dei controlli e il modo in cui viene generato il codice. Per altre informazioni, vedere [generazione e compilazione di codice sorgente dinamico](/dotnet/framework/reflection-and-codedom/dynamic-source-code-generation-and-compilation).
