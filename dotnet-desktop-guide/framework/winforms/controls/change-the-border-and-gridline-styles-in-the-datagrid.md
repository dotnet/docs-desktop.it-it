...
> [!NOTE]
> Il colore della griglia viene utilizzato solo con <xref:System.Windows.Forms.DataGridViewCellBorderStyle.Single> i <xref:System.Windows.Forms.DataGridViewCellBorderStyle.SingleHorizontal> valori, e <xref:System.Windows.Forms.DataGridViewCellBorderStyle.SingleVertical> dell' <xref:System.Windows.Forms.DataGridViewCellBorderStyle> enumerazione e il <xref:System.Windows.Forms.DataGridViewHeaderBorderStyle.Single> valore dell' <xref:System.Windows.Forms.DataGridViewHeaderBorderStyle> enumerazione. Gli altri valori di queste enumerazioni utilizzano i colori specificati dal sistema operativo. Inoltre, quando gli stili di visualizzazione sono abilitati in Windows XP e la famiglia di Windows Server 2003 tramite il <xref:System.Windows.Forms.Application.EnableVisualStyles%2A?displayProperty=nameWithType> metodo, il <xref:System.Windows.Forms.DataGridView.GridColor%2A> valore della proprietà non viene utilizzato.  
