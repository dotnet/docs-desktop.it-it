...
Per altre informazioni, vedere [Cenni preliminari sul data binding](/dotnet/desktop-wpf/data/data-binding-overview).
...
Per altre informazioni, vedere [Cenni preliminari sulle forme e il disegno di base in WPF](/dotnet/desktop-wpf/data/data-binding-overview).
...
Per altre informazioni, vedere [Risorse](/dotnet/desktop-wpf/fundamentals/xaml-resources-define).
