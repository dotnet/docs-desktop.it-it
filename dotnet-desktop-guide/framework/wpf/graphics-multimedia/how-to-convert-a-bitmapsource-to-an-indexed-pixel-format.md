...
ms.locfileid: "96968032"
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="505fd-102">Procedura: convertire un elemento BitmapSource in un formato a pixel indicizzati</span><span class="sxs-lookup"><span data-stu-id="505fd-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="505fd-103">In questo esempio viene illustrato come convertire un oggetto <xref:System.Windows.Media.Imaging.BitmapSource> in un formato pixel indicizzato.</span><span class="sxs-lookup"><span data-stu-id="505fd-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="505fd-104">Esempio</span><span class="sxs-lookup"><span data-stu-id="505fd-104">Example</span></span>  
