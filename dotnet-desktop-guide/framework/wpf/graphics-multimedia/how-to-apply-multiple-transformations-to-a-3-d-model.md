...
---
# <a name="how-to-apply-multiple-transformations-to-a-3d-model"></a>Procedura: applicare più trasformazioni a un modello 3D
Questo esempio illustra come usare un oggetto <xref:System.Windows.Media.Media3D.RotateTransform3D> e un oggetto <xref:System.Windows.Media.Media3D.ScaleTransform3D> per ruotare e modificare la scala di un modello 3D. Il codice riportato di seguito illustra come applicare queste trasformazioni alla <xref:System.Windows.Media.Media3D.Model3D.Transform%2A> proprietà di un oggetto <xref:System.Windows.Media.Media3D.GeometryModel3D> in XAML.  
