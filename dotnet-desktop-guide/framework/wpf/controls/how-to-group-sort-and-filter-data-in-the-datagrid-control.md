...
2. In XAML creare un'istanza della classe Collection e impostare la [direttiva x:Key](/dotnet/desktop-wpf/xaml-services/xkey-directive).

3. In XAML creare un'istanza della <xref:System.Windows.Data.CollectionViewSource> classe, impostare la [direttiva x:Key](/dotnet/desktop-wpf/xaml-services/xkey-directive)e impostare l'istanza della classe di raccolta come <xref:System.Windows.Data.CollectionViewSource.Source%2A> .
