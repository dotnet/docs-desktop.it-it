...
Per altre informazioni su stili, modelli e trigger, vedere [Applicazione di stili e modelli](/dotnet/desktop-wpf/fundamentals/styles-templates-overview).
...
Per ulteriori informazioni su data binding, vedere [Cenni preliminari sul data binding](/dotnet/desktop-wpf/data/data-binding-overview).
