...
## <a name="highlights"></a>Elementi di rilievo  
...
- [How to: Add a Command to a MenuItem (Procedura: Aggiungere un comando a un MenuItem)](/previous-versions/dotnet/netframework-3.5/ms741839(v=vs.90))
