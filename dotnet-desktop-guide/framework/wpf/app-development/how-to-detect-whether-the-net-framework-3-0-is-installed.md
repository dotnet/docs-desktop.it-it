...
> [!NOTE]
> Per informazioni più dettagliate sull'installazione, la distribuzione e il rilevamento di Microsoft .NET Framework, vedere la sezione relativa alla [distribuzione di Microsoft .NET Framework versione 3,0](/previous-versions/dotnet/articles/aa480198(v=msdn.10)).  
  
<a name="content_expiration"></a>

## <a name="detect-the-net-clr-user-agent-string"></a>Rilevare la stringa di User-Agent ".NET CLR"  
