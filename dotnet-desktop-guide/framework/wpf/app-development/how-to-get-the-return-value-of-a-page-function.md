...
## <a name="example"></a>Esempio  
 Per ottenere il risultato restituito da una funzione di pagina, è necessario gestire <xref:System.Windows.Navigation.PageFunction%601.Return> la funzione di pagina che si sta chiamando.  
