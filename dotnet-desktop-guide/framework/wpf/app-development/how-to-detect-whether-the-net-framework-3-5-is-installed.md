...
---
# <a name="how-to-detect-whether-the-net-framework-35-is-installed"></a>Procedura: rilevare se è installato il .NET Framework 3,5
...
> [!NOTE]
> Per informazioni più dettagliate sull'installazione, la distribuzione e il rilevamento del .NET Framework, vedere [Install the .NET Framework for Developers](/dotnet/framework/install/guide-for-developers).  
