...
---
# <a name="differences-in-wpf-net"></a>Differenze in WPF .NET
...
Alcune funzionalità di .NET Framework non sono supportate da .NET Core. Per ulteriori informazioni sulle tecnologie non supportate, vedere [.NET Framework tecnologie non disponibili in .NET Core](/dotnet/core/porting/net-framework-tech-unavailable).
...
| Assembly di origine | Assembly di destinazione | Tipo                |
| --------------- | --------------- | ------------------- |
